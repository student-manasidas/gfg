<h2><a href="https://practice.geeksforgeeks.org/problems/count-pairs-in-array-divisible-by-k/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Count pairs in array divisible by K</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array&nbsp;<strong>A[]&nbsp;</strong>and positive integer&nbsp;<strong>K</strong>, the task is to count total number of pairs in the array whose sum is divisible by&nbsp;<strong>K</strong>.</span></p>
